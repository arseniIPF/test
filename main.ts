tiles.loadMap(tiles.createMap(tilemap`nivel1`))
let homonet = sprites.create(img`
    . . . . . . f f f f . . . . . . 
    . . . . f f f 2 2 f f f . . . . 
    . . . f f f 2 2 2 2 f f f . . . 
...
let cosa = sprites.create(img`
    ...
    ....44444.......................
    `, SpriteKind.Food)
cosa.setBounceOnWall(true)
controller.moveSprite(homonet)
cosa.setVelocity(50, 50)
